  ...
  <div class="shop-info" ref="info">
    <div class="info-content">
      ...
      <section class="section">
        ...
        <div class="activity">
          <div class="activity-item activity-green" :class="supportClasses[info.supports[index].type]"
          v-for="(activity,index) in info.supports" :key="index">
...
export default {
  ...
  mounted() {
    this.$nextTick(()=>{
      this.shopInformation=new BScroll(this.$refs.info,{ click:true})
