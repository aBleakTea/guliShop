<template>
  <div class="shop-header">
    <nav class="shop-nav" :style="{backgroundImage:`url(${info.bgImg})`}">
      <a class="back" @click="$router.back()"> <i class="icon-icon-icon_arrow_left"></i> </a>
    </nav>
    ...
    <div class="shop-content">
      ...
      <div class="header-content">
        ...
        <div class="shop-message">
          ...
          <span class="shop-message-detail">距离 {{info.distance}}分钟</span>
        </div>
      </div>
    </div>
    ...
    <div class="shop-brief-modal" v-show="shopShow">
      <div class="brief-modal-content">
        ...
        <div class="mask-footer" @click="toggleShopShow"><span class="iconfont icon-guanbi1"></span></div>
      </div>
    ...
    <div class="activity-sheet" v-show="supportShow">
      <div class="activity-sheet-content">
        ...
        <ul class="list">
          <li class="activity-item activity-red" v-for="(support, index) in info.supports" :key="index">
